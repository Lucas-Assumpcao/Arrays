...
//produtos.push ({ id:101, nome: "Água de Coco", preco_venda: 1.59, preco_compra: 0.80, estoque: 500, rotatividade: "alta", curva_abc: "B"});
//console.table(produtos);

//produtos.pop();
//console.table(produtos);

//produtos[100].preco_venda = 0;
//console.table(produtos);
...
//let descontos = produtos.map(produto => ({ ...produto,  preco_com_desconto: produto.preco_venda * 0.9}))
//console.table(descontos);
